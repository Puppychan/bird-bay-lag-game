...
void printName() {
	...
	// drawLetter('N', 360, 80, 0x00FF7F00);
	// drawLetter('h', 400, 80, 0x00FF0000);
	// drawLetter('u', 440, 80, 0x009400D3);
	// drawLetter('n', 480, 80, 0x004B0082);
	// drawLetter('g', 520, 80, 0x000000FF);
